package org.jpos.jposext.cbcom.session.server.service.support;
...
/**
 * Dummy state for test purpose only
 * 
 * @author dgrandemange
 *
 */
public class DummyState extends PseudoSessionStateAbstractImpl {
